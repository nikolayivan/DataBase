...
#                      hover_data = ["серийный номер"],
    ...
    df1 = pd.read_excel(r'U:\TestCentre\Иванов\Журнал учета серийных номеров.xlsx',
                    sheet_name='ЭОБ',
                    header=0,
                    usecols=['серийный номер','название проекта','Наименование ПС', 'Класс напряжения', 'Локация','тип ЭОБ', 'дата', 'серийный номер трансформатора, в который входит ЭОБ'],
                   )

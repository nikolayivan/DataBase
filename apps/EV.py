    ...
    with st.expander('Описание:'):
        ...
        **Задача оптимизации** — рассчитать суточный график зарядки электромобилей, с учётом ограничения по установленной мощности подстанции, который:
        ...
        - указатель, который определяет выбор типа файла с данными по потреблению домов, который пользователь загрузит в программу.
           ...
           - 1 — файл с данными по суточному потреблению одного дома.

         На основе этих данных программа рассчитает примерный профиль потребления желаемого количества домов.

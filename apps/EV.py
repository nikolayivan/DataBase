...
def app():
    ...
    with st.expander('Описание:'):
        ...
        - **use_quick_charges** — указание на то, учитывать ли три быстрые зарядки по 50 кВт:
          - зарядка 1 - с `12` до `14`; с `1`6 до `17`; с `19` до `21`
          - зарядка 2 - с `13` до `15`; с `15:30` до `17`; с `18` до `20`; с `10` до `11`
          - зарядка 3 - с `12` до `13`; с `13` до `15`; с `16` до `18`; с `21` до `23`; с `11` до `12` 
